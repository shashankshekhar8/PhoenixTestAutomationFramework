...
public class CreateJobPayload {
	...
	public String toString() {
		return "CreateJobPayload [mst_service_location_id=" + mst_service_location_id + ", mst_platform_id="
				...
				+ ", getMst_warrenty_status_id()=" + getMst_warrenty_status_id() + ", getMst_oem_id()="
				+ getMst_oem_id() + ", getCustomer()=" + getCustomer() + ", getCustomer_address()="
				+ getCustomer_address() + ", getCustomer_product()=" + getCustomer_product() + ", getProblems()="
				+ Arrays.toString(getProblems()) + ", getClass()=" + getClass() + ", hashCode()=" + hashCode()
